...
option_list <- list(
  make_option("--project_dir", type = "character", default = project_dir_default, help = "Project directory [default: %default]"),
  make_option("--dir_p4", type = "character", default = file.path(project_dir_default, "results", "Package4_CrossCohortValidation_Velmeshev_v2"), help = "Package4 v2 directory [default: %default]"),
  make_option("--dir_p4b", type = "character", default = file.path(project_dir_default, "results", "Package4b_DirectionConsistencySummary_v2_manual"), help = "Package4b directory [default: %default]"),
  make_option("--dir_p5", type = "character", default = file.path(project_dir_default, "results", "Package5_DirectionalConcordance_GlobalSummary"), help = "Package5 directory [default: %default]"),
  make_option("--dir_p7", type = "character", default = file.path(project_dir_default, "results", "Package7_MinimalRobustnessAnalysis"), help = "Package7 directory [default: %default]"),
  make_option("--outdir", type = "character", default = file.path(project_dir_default, "results", "Figure5_Velmeshev_Validation"), help = "Output directory [default: %default]")
)
