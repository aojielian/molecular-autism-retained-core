...
option_list <- list(
  make_option("--root", type = "character", default = Sys.getenv("MA_TF_OUTDIR", file.path(project_dir_default, "results", "Package10_TF_prioritization")), help = "Package10 TF-prioritization directory [default: %default]"),
  make_option("--outdir", type = "character", default = file.path(project_dir_default, "results", "Supplementary_Figures", "S5_TF_Enrichment"), help = "Output directory [default: %default]")
)
