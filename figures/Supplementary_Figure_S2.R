...
option_list <- list(
  ...
  make_option("--pkg1", type = "character", default = file.path(project_dir_default, "results", "Package1_Figure1_DiscoveryAudit"), help = "Package1 directory [default: %default]"),
  make_option("--pkg1b", type = "character", default = file.path(project_dir_default, "results", "Package1b_ClusterAnnotation_ContaminantAudit"), help = "Package1b directory [default: %default]"),
  make_option("--outdir", type = "character", default = file.path(project_dir_default, "results", "Supplementary_Figures", "S2_Discovery_QC"), help = "Output directory [default: %default]")
)
