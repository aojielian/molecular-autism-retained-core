...
def main():
    ...
    ap.add_argument(
        "--outdir",
        default=env_or_none("MA_DRUG_OUTDIR") or project_default("results", "Package9_PerturbationPrioritization")
    )
    ...
    if args.signature_tsv is None or args.pooled_de_tsv is None or args.outdir is None:
        ap.error("Provide --signature_tsv, --pooled_de_tsv, and --outdir, or set MA_PROJECT_DIR/MA_FROZEN_SIGNATURE_TSV/MA_POOLED_DE_TSV/MA_DRUG_OUTDIR")
