...
option_list <- list(
  ...
  make_option("--outdir", type = "character",
              default = file.path(DEFAULT_PROJECT_DIR, "results", "Package3_Discovery_DonorAwareDiseaseAssociation")),
...
if (is.na(opt$rds) || opt$rds == "") stop("Please provide --rds or set MA_STRICT_RDS.")
