...
PKG4_DIR    <- file.path(PROJECT_DIR, "Package4_CrossCohortValidation_Velmeshev_v2")
STRICT_DIR  <- file.path(PROJECT_DIR, "Package4b_DirectionConsistencySummary_v2_manual")
PKG5_DIR    <- file.path(PROJECT_DIR, "Package5_DirectionalConcordance_GlobalSummary")
OUTDIR      <- file.path(PROJECT_DIR, "Package7_MinimalRobustnessAnalysis")
