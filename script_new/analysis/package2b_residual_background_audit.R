...
cfg <- list(
  ...
  outdir = "/gpfs/hpc/home/lijc/lianaoj/autism_scRNA/MolecularAutism_Revision/Package2b_ResidualBackgroundAudit",
  assay = "RNA",
  ...
  neuronal_high_quantile = 0.90,
  scrublet_high_quantile = 0.95,
