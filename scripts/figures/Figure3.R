...
option_list <- list(
  ...
  make_option("--outdir", type = "character", default = file.path(project_dir_default, "results", "Figure3_Discovery_DiseaseAssociation"), help = "Output directory [default: %default]")
)
