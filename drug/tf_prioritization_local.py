...
def main():
    ap = argparse.ArgumentParser(description="Local TF prioritization for the candidate/reference remodeling axis")
    ap.add_argument(
        "--signature_tsv",
    ...
    ap.add_argument(
        "--outdir",
        default="/Users/aojie/PROJECTs/molecular_autism/drug/Package10_TF_prioritization_local"
    )
